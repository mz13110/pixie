 ...
 *
 * @author   GoogleChromeLabs <http://github.com/orgs/GoogleChromeLabs>
 * @license  Apache-2.0
 */

/*
 * custom build with these changes:
 *  + added ability to enable & disable zoom, pan, etc.
 *  + moved css to another file, inject styles yourself lol
 */
...
var PinchZoom = (function () {
    ...
    class PinchZoom extends HTMLElement {
        ...
        constructor() {
            ...
            this.enabledFeatures = { zoom: true, pan: true };
        ...
        static isFeature(feature) {
            return features.includes(feature);
        }
        enable(feature) {
            if (PinchZoom.isFeature(feature))
